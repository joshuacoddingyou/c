...
OBJECTFILES= \
	...
	${OBJECTDIR}/snooper.o \
	${OBJECTDIR}/test-port-client.c.o
...
${OBJECTDIR}/test-port-client.c.o: test-port-client.c.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test-port-client.c.o test-port-client.c.c
