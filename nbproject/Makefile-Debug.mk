...
${OBJECTDIR}/connected-peer.o: connected-peer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connected-peer.o connected-peer.c

${OBJECTDIR}/connectionless-receiver.o: connectionless-receiver.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connectionless-receiver.o connectionless-receiver.c

${OBJECTDIR}/connectionless-sender.o: connectionless-sender.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connectionless-sender.o connectionless-sender.c

${OBJECTDIR}/echo-process.o: echo-process.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/echo-process.o echo-process.c

${OBJECTDIR}/echo-thread.o: echo-thread.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/echo-thread.o echo-thread.c

${OBJECTDIR}/exec-server.o: exec-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exec-server.o exec-server.c

${OBJECTDIR}/html-ls-server.o: html-ls-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html-ls-server.o html-ls-server.c

${OBJECTDIR}/html-ls-server2.o: html-ls-server2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html-ls-server2.o html-ls-server2.c

${OBJECTDIR}/http-client.o: http-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/http-client.o http-client.c

${OBJECTDIR}/http-dir.o: http-dir.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/http-dir.o http-dir.c

${OBJECTDIR}/ls-server.o: ls-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ls-server.o ls-server.c

${OBJECTDIR}/parent-child.o: parent-child.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parent-child.o parent-child.c

${OBJECTDIR}/serverls.o: serverls.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serverls.o serverls.c

${OBJECTDIR}/simple-client.o: simple-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simple-client.o simple-client.c

${OBJECTDIR}/simple-server.o: simple-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simple-server.o simple-server.c

${OBJECTDIR}/snooper.o: snooper.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/snooper.o snooper.c

${OBJECTDIR}/test-port-client.o: test-port-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test-port-client.o test-port-client.c

${OBJECTDIR}/thread-mutex.o: thread-mutex.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread-mutex.o thread-mutex.c

${OBJECTDIR}/trivial-server.o: trivial-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trivial-server.o trivial-server.c

${OBJECTDIR}/ttcp-client.o: ttcp-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ttcp-client.o ttcp-client.c

${OBJECTDIR}/ttcp-server.o: ttcp-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ttcp-server.o ttcp-server.c

${OBJECTDIR}/udp-reconnect.o: udp-reconnect.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/udp-reconnect.o udp-reconnect.c

${OBJECTDIR}/udp-server.o: udp-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/udp-server.o udp-server.c
